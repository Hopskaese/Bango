...
g++ --std=c++11 -pthread -I include/ -c -o bin/obj/CSkill.o MainServer/GameCharacter/Skill/CSkill.cpp
g++ --std=c++11 -pthread -I include/ -c -o bin/obj/CSkillActiveUse.o MainServer/GameCharacter/Skill/CSkillActiveUse.cpp
g++ --std=c++11 -pthread -I include/ -c -o bin/obj/CSkillActiveOnce.o MainServer/GameCharacter/Skill/CSkillActiveOnce.cpp
g++ --std=c++11 -pthread -I include/ -c -o bin/obj/CSkillChant.o MainServer/GameCharacter/Skill/CSkillChant.cpp
g++ --std=c++11 -pthread -I include/ -c -o bin/obj/CSkillPassive.o MainServer/GameCharacter/Skill/CSkillPassive.cpp
g++ --std=c++11 -pthread -I include/ -c -o bin/obj/CLightningSlash.o MainServer/GameCharacter/SkillIndiv/CLightningSlash.cpp
...
g++ --std=c++11 -pthread -o bin/MainServer bin/obj/tinyxml2.o bin/obj/CSocket.o bin/obj/CConfig.o bin/obj/CMacro.o bin/obj/CItemInfo.o bin/obj/CMacroDB.o bin/obj/CItem.o bin/obj/CItemGeneral.o bin/obj/CItemWeapon.o bin/obj/CItemDefense.o bin/obj/CItemYinyang.o bin/obj/CItemPet.o bin/obj/CItemRide.o bin/obj/CItemOrnament.o bin/obj/CItemTransform.o bin/obj/CClient.o bin/obj/CCharacter.o bin/obj/CPlayer.o bin/obj/CParty.o bin/obj/CNPC.o bin/obj/CMonster.o bin/obj/CMonsterReal.o bin/obj/CSkill.o bin/obj/CSkillActiveOnce.o bin/obj/CSkillActiveUse.o bin/obj/CSkillPassive.o bin/obj/CSkillChant.o bin/obj/CLightningSlash.o bin/obj/CTile.o bin/obj/CMap.o bin/obj/CServer.o bin/obj/CDBSocket.o bin/obj/CClientSocket.o bin/obj/main.o
